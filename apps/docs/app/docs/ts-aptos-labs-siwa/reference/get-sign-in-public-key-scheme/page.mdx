...
const scheme1 = getSignInPublicKeyScheme(ed25519Key); // "ed25519"

const singleKey = new AnyPublicKey(ed25519Key);
const scheme2 = getSignInPublicKeyScheme(singleKey); // "single_key"

// From a SigningScheme enum
const scheme3 = getSignInPublicKeyScheme(SigningScheme.Ed25519); // "ed25519"
```
